...
class SalaryGrowthStatisticsGraph extends StatefulWidget {
  const SalaryGrowthStatisticsGraph({super.key});

  @override
  State<SalaryGrowthStatisticsGraph> createState() =>
      _SalaryGrowthStatisticsGraphState();
}

class _SalaryGrowthStatisticsGraphState
    extends State<SalaryGrowthStatisticsGraph> {
  ...
  void initState() {
    ...
    _cubit.onSgStatisticsCategoryChanged(HrInsightsCategoryEnums.jobTitle);
  }
    ...
    return SizedBox(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 4.h),
          Text(
            HrInsightsStrings.viewSalaryGrowthStatics,
                    ...
                    builder: (context, state) {
                      ...
                      return Row(
                        ...
                        children: [
                          ...
                          CustomSwitch(
                            onChanged: _cubit.onSgCompareWithMarketChanged,
                            value: value,
